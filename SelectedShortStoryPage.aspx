...
<body>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <asp:TextBox ID="SelectedShortStoryTextBox"  runat="server" class="textbox" oncopy="return false" onpaste="return false" oncut="return false" ondelete="return false" Font-Bold="True" Font-Size="XX-Large" OnTextChanged="SelectedShortStoryTextBox_TextChanged" style="z-index: 1; left: 11px; top: 13px; position: absolute; width: 500px; height: 700px;" BorderColor="White" BorderStyle="Solid" BorderWidth="5px" AutoPostBack="True" Font-Names="Forte" ReadOnly="True" TextMode="MultiLine"></asp:TextBox>
