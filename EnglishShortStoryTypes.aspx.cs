...
{
    public partial class EnglishShortStoryTypes : System.Web.UI.Page
    {
        ...
        protected void EnglishShortStoryTypesDataList_SelectedIndexChanged1(object sender, EventArgs e)
        {
        ...
        protected void LoveShortStoryImageButton_Click(object sender, ImageClickEventArgs e)
        {

        }

        protected void ComfortShortStoryImageButton_Click(object sender, ImageClickEventArgs e)
        {
